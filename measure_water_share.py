...
the product together.
    ...
    uv run measure_water_share.py --tile N40W080 --lat 38.00 --lon -76.25 \
...
is read straight from disk and needs no credentials:
    ...
    uv run measure_water_share.py --from-cache ../lst-tiles/block_K.npz.raw.npz
"""
...
import destripe
import lst_qa
from lst_qa import QA_WATER_BITS, masked_celsius
