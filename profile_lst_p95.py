...
# --------------------------------------------------------------------------
# Memory sampler. Runs in its own process.
#
# It must not be a thread. The client process holds the GIL for long stretches
# while it builds the graph, which is exactly when the sampler must not drift.
# --------------------------------------------------------------------------
