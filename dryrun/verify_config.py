...
from profile_lst_p95 import build_graph, predict_working_set
...
print(f"lst_p95       shape {lst.shape}  dtype {lst.dtype}  chunks {lst.chunks[0][0]} px")
...
for slots in (16, 32):
    print(f"  x{slots} concurrent reads = {read_block_mb*slots/1000:.1f} GB in flight")
