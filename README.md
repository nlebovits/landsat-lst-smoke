...
This codebase carries an [Apache 2.0](./LICENSE) license. The data themselves are available under `CC0-1.0`, based on USGS terms for Landsat Collection 2 products.
